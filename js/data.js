...
const KNOWN_DETAILS = {
  kabutomushi: {
    attack: 720, defense: 600, hand: "グー",
    size: "体長(たいちょう) 3〜5cm（角(つの)を いれると 8cm ちかく）・重(おも)さ 5〜10g",
    family: "コガネムシ科",
  ...
  kuwagata: {
    attack: 700, defense: 580, hand: "チョキ",
    size: "体長(たいちょう) 3〜7cm（あごを いれた ながさ）",
    family: "クワガタムシ科",
  ...
  tentoumushi: {
    attack: 180, defense: 260, hand: "パー",
    size: "体長(たいちょう) 5〜8mm。1円玉(えんだま)より ずっと 小(ちい)さいよ",
    family: "テントウムシ科",
  ...
  monshirochou: {
    attack: 150, defense: 170, hand: "パー",
    size: "羽(はね)を ひろげて 4.5〜6cm",
    family: "シロチョウ科",
  ...
  agehachou: {
    attack: 260, defense: 220, hand: "パー",
    size: "羽(はね)を ひろげて 8〜12cm。日本(にほん)の チョウでは 大(おお)きい ほう",
    family: "アゲハチョウ科",
  ...
  tonbo: {
    attack: 340, defense: 200, hand: "チョキ",
    size: "体長(たいちょう) 5〜7cm・羽(はね)を ひろげて 8〜10cm",
    family: "トンボ科",
  ...
  semi: {
    attack: 220, defense: 300, hand: "パー",
    size: "体長(たいちょう) 5〜6cm（アブラゼミ）",
    family: "セミ科",
  ...
  batta: {
    attack: 300, defense: 240, hand: "グー",
    size: "体長(たいちょう) 3〜7cm。メスの ほうが 大(おお)きいよ",
    family: "バッタ科",
  ...
  koorogi: {
    attack: 230, defense: 250, hand: "チョキ",
    size: "体長(たいちょう) 2〜3cm",
    family: "コオロギ科",
  ...
  kamakiri: {
    attack: 560, defense: 300, hand: "チョキ",
    size: "体長(たいちょう) 7〜9cm（オオカマキリ）",
    family: "カマキリ科",
  ...
  ari: {
    attack: 200, defense: 210, hand: "グー",
    size: "体長(たいちょう) 3〜12mm。しゅるいで ずいぶん ちがうよ",
    family: "アリ科",
  ...
  dangomushi: {
    attack: 120, defense: 480, hand: "パー",
    size: "体長(たいちょう) 1〜1.4cm。まるまると 小(ちい)さな ボールに",
    family: "オカダンゴムシ科",
  ...
  mitsubachi: {
    attack: 380, defense: 190, hand: "チョキ",
    size: "体長(たいちょう) 1.2〜1.5cm",
    family: "ミツバチ科",
  ...
  katatsumuri: {
    attack: 110, defense: 520, hand: "パー",
    size: "殻(から)の 大(おお)きさ 2〜3cm",
    family: "オナジマイマイ科",
  ...
  kumo: {
    attack: 420, defense: 240, hand: "チョキ",
    size: "体(からだ) 1〜3cm（ジョロウグモの メス）。巣(す)は 1m ちかく に なる ことも",
    family: "ジョロウグモ科",
  ...
  koganemushi: {
    attack: 330, defense: 380, hand: "グー",
    size: "体長(たいちょう) 1.7〜2.4cm",
    family: "コガネムシ科",
  ...
  amenbo: {
    attack: 190, defense: 180, hand: "パー",
    size: "体長(たいちょう) 1.1〜1.6cm。あしを ひろげると もっと 大(おお)きく みえる",
    family: "アメンボ科",
  ...
  suzumushi: {
    attack: 210, defense: 230, hand: "チョキ",
    size: "体長(たいちょう) 1.7〜2.5cm",
    family: "コオロギ科",
  ...
  /* ---- おはな ---- */
  tanpopo: {
    attack: 150, defense: 320, hand: "パー",
    size: "花(はな) 3〜5cm・高(たか)さ 10〜30cm",
    family: "キク科",
  ...
  sakura: {
    attack: 280, defense: 400, hand: "パー",
    size: "花(はな) 3〜4cm・木(き)の 高(たか)さ 10〜25m",
    family: "バラ科",
  ...
  tulip: {
    attack: 210, defense: 260, hand: "パー",
    size: "花(はな) 5〜8cm・高(たか)さ 20〜50cm",
    family: "ユリ科",
  ...
  himawari: {
    attack: 420, defense: 480, hand: "グー",
    size: "花(はな) 20〜30cm・高(たか)さ 1〜3m",
    family: "キク科",
  ...
  asagao: {
    attack: 190, defense: 230, hand: "パー",
    size: "花(はな) 7〜10cm・つるは 2〜3m のびる",
    family: "ヒルガオ科",
  ...
  clover: {
    attack: 130, defense: 340, hand: "パー",
    size: "花(はな) 1.5〜2cm・高(たか)さ 10〜20cm",
    family: "マメ科",
  ...
  kinoko: {
    attack: 360, defense: 300, hand: "グー",
    size: "かさの 大(おお)きさ 2〜15cm（しゅるいで まちまち）",
  ...
  donguri: {
    attack: 240, defense: 560, hand: "グー",
    size: "1〜3cm。しゅるいで 丸(まる)いのや 細長(ほそなが)いのが あるよ",
    family: "ブナ科",
  ...
  momiji: {
    attack: 200, defense: 280, hand: "チョキ",
    size: "葉(は) 4〜7cm・木(き)の 高(たか)さ 10〜15m",
    family: "ムクロジ科",
