...
const KNOWN_DETAILS = {
  kabutomushi: {
    trivia: ["じぶんの からだの 20ばいの おもさを ひっぱれる、ちからもち だよ。",
             "おおきな つのが あるのは オスだけ。メスには つのが ないよ。",
             "たまごから おとなに なるまで 1ねん かかるけど、おとなで いられるのは 2かげつ くらい。"],
    habitat: "ほんしゅう・しこく・きゅうしゅうの ざつぼくりん。くぬぎや こならの きが おおい はやしに すんでいるよ。ひるまは おちばの したや きの ねもとに かくれているんだ。",
    season: "6がつ〜8がつ。よるから あさ はやくが いちばん みつけやすいよ。",
    food: "きの みつ。かうときは こんちゅうゼリーを あげてね。",
    care: "むしかごに くろい つち（マット）を ふかく いれて、のぼりぎと こんちゅうゼリーを おく。つちが かわいたら きりふきで しめらせる。オスどうしは けんかするから べつべつに してね。",
  },
  kuwagata: {
    trivia: ["おおきな あごは たたかう ための どうぐ。ものを はさむ ちからが とても つよいよ。",
             "しゅるいに よっては、おとなで 2〜3ねんも いきる ものが いるんだ。",
             "ようちゅうは くさった きの なかを たべながら そだつよ。"],
    habitat: "にほん ぜんこくの ざつぼくりん。くぬぎ・こなら・やなぎなど、みつが でる きの みきに あつまるよ。きの うろや かわの すきまに かくれているんだ。",
    season: "6がつ〜9がつ。よるや あさ はやくが みつけやすいよ。",
    food: "きの みつ。かうときは こんちゅうゼリーを あげてね。",
    care: "つちを ふかく いれた むしかごに、のぼりぎと こんちゅうゼリー。ひかげの すずしい ところに おくよ。はさまれると いたいから、せなかを もつと あんしん。",
  },
  tentoumushi: {
    trivia: ["アブラムシを 1にちに 100ぴきも たべる、はたけの おてつだいむし だよ。",
             "てきに おそわれると、あしから きいろい しるを だして みを まもるんだ。",
             "ほしの かずは しゅるいに よって ちがう。ななほし テントウは 7つ だよ。"],
    habitat: "こうえん・はたけ・かわらの くさむら。ぜんこくに いるよ。アブラムシが つく くさの まわりに おおいんだ。",
    season: "3がつ〜11がつ。はると あきに とくに おおいよ。",
    food: "アブラムシ。",
    care: "アブラムシが ついた くさの えだごと むしかごに いれると かえるよ。えさが なくなったら、そっと にがして あげてね。",
  },
  monshirochou: {
    trivia: ["はねの こなを さわると とれちゃう。やさしく みるだけに しようね。",
             "キャベツの はに たまごを うむよ。ようちゅうは あおむし だよ。",
             "はねの くろい てんの かずで オスと メスが みわけられるんだ。"],
    habitat: "ぜんこくの はたけ・こうえん・かだん。キャベツや だいこんなど アブラナの なかまが ある ところに おおいよ。",
    season: "3がつ〜11がつ。あたたかい ひるまに とんでいるよ。",
    food: "おとなは はなの みつ。ようちゅう（あおむし）は キャベツの は。",
    care: "あおむしを キャベツの はと いっしょに かごに いれると、さなぎに なって ちょうに なるよ。うまれたら すぐ そとへ にがして あげてね。",
  },
  agehachou: {
    trivia: ["ようちゅうは さわると オレンジの つのを だして、くさい においで みを まもるよ。",
             "みかんや さんしょうの はを たべて そだつんだ。",
             "はねを ひろげると 10センチ ちかく。にほんの ちょうの なかでは おおきい ほうだよ。"],
    habitat: "ぜんこくの こうえん・にわ・やまみち。みかんの きや さんしょうが ある ところに よく くるよ。",
    season: "4がつ〜10がつ。はれた ひの ひるまに とんでいるよ。",
    food: "おとなは はなの みつ。ようちゅうは みかん・さんしょうの は。",
    care: "ようちゅうを みかんの はと いっしょに かごへ。はは まいにち あたらしい ものに とりかえてね。ちょうに なったら そとへ にがそう。",
  },
  tonbo: {
    trivia: ["めが 2まんこ いじょうの ちいさな めで できていて、ほとんど ぜんぶが みえるよ。",
             "そらを とびながら ほかの むしを つかまえて たべる ハンター だよ。",
             "こどもの ころは「ヤゴ」と いって、みずの なかで くらすんだ。"],
    habitat: "いけ・たんぼ・かわの ちかく。ぜんこくに いるよ。みずべの くさや ぼうの さきに とまって いることが おおいんだ。",
    season: "5がつ〜11がつ。はれた ひの ひるまに とんでいるよ。",
    food: "ちいさな むし（か・はえ など）。",
    care: "とんぼを かうのは とても むずかしいよ。みたら そっと にがして あげてね。ヤゴなら みずそうで そだてられるけど、いきた えさが ひつよう だよ。",
  },
  semi: {
    trivia: ["つちの なかで なんねんも すごしてから、やっと そとへ でて くるんだ。",
             "ないているのは オスだけ。メスを よんでいるんだよ。",
             "そとに でて からは 2〜4しゅうかんくらいしか いきられないんだ。"],
    habitat: "ぜんこくの こうえん・はやし・まちの なみき。さくらや けやきの みきに とまって ないているよ。",
    season: "7がつ〜9がつ。あさから ゆうがたに ないているよ。",
    food: "きの しる（みきに くちを さして すう）。",
    care: "せみを かうのは とても むずかしいよ。きの しるしか のめないんだ。みたら そっと にがして あげてね。ぬけがらを あつめるのは たのしいよ。",
  },
  batta: {
    trivia: ["じぶんの からだの 20ばい いじょうの きょりを ジャンプ できるよ。",
             "みみは あたまでは なくて、おなかの よこに ついているんだ。",
             "くさむらの いろに にせて、てきから みつからない ように しているよ。"],
    habitat: "ぜんこくの くさむら・かわら・こうえんの しばふ。ひあたりの よい ところが すきだよ。",
    season: "7がつ〜11がつ。ひるまに くさむらで みつかるよ。",
    food: "いねかや えのころぐさ など、やわらかい くさの は。",
    care: "むしかごに つちを しいて、いきた くさを さしておくよ。くさは まいにち あたらしい ものに。きりふきで すこし みずを あげてね。",
  },
  koorogi: {
    trivia: ["はねを こすりあわせて「コロコロ」と ないているんだ。ないているのは オスだよ。",
             "きおんが たかい ほど、なく はやさが はやく なるよ。",
             "なんでも たべる。やさいも おかかも たべるんだ。"],
    habitat: "ぜんこくの いしの した・くさむら・にわの すみ。くらくて しめった ところに かくれているよ。",
    season: "8がつ〜11がつ。よるに よく ないているよ。",
    food: "くさ・やさい・かつおぶし など いろいろ。",
    care: "つちを しいた むしかごに、かくれる ばしょ（たまごパックなど）を いれる。なすや きゅうり、かつおぶしを すこし。みずは きりふきで。かいやすい むし だよ。",
  },
  kamakiri: {
    trivia: ["まえあしで えものを つかまえる、くさむらの ハンター だよ。",
             "あたまを ぐるっと うしろまで まわせるんだ。",
             "たまごは あわあわの ふくろに つつまれて ふゆを こすよ。"],
    habitat: "ぜんこくの くさむら・こうえん・にわ。せの たかい くさや えだの うえで じっと まっているよ。",
    season: "8がつ〜11がつ。ひるまに くさむらで みつかるよ。",
    food: "いきた むし（ばった・こおろぎ・はえ など）。",
    care: "むしかごに のぼる えだを いれて、いきた むしを あげるよ。いきた えさが ようい できない ときは、そっと にがして あげてね。",
  },
  ari: {
    trivia: ["じぶんの たいじゅうの 50ばいの ものを もちあげられる ちからもち だよ。",
             "においの みちを つけて、なかまに えさの ばしょを おしえるんだ。",
             "すの なかには たまごを うむ「じょおうあり」が いるよ。"],
    habitat: "ぜんこくの じめん・こうえん・いえの まわり。つちの なかや いしの したに すを つくるよ。",
    season: "4がつ〜10がつ。あたたかい ひの ひるまに よく はたらいているよ。",
    food: "あまい もの・むしの しがい・アブラムシの だす しる。",
    care: "とうめいな いれものに つちを いれると、すを つくる ようすが みられるよ。さとうみずを ちょっぴり。にげやすいから ふたを しっかりね。",
  },
  dangomushi: {
    trivia: ["さわると まるく なるのは、てきから みを まもる ため だよ。",
             "じつは むしの なかまでは なくて、エビや カニに ちかい なかま なんだ。",
             "おちばを たべて、つちを ふかふかに してくれる おてつだいさん だよ。"],
    habitat: "ぜんこくの いしの した・うえきばちの した・おちばの なか。しめって くらい ところが すきだよ。",
    season: "1ねんじゅう。はるから あきが みつけやすいよ。",
    food: "おちば・かれた くさ・やさいの きれはし。",
    care: "つちと おちばを いれた いれものに いれるだけ。きりふきで しめらせて、にんじんや きゅうりを すこし。とても かいやすいよ。",
  },
  mitsubachi: {
    trivia: ["はちみつ 1キロを つくるのに、はなを 500まん かい たずねるんだ。",
             "おどりで なかまに はなの ばしょを おしえるよ。",
             "はなから はなへ とんで、たねや みが できる おてつだいを しているんだ。"],
    habitat: "ぜんこくの はなばたけ・こうえん・かだん。はなが たくさん さいている ところに あつまるよ。",
    season: "3がつ〜10がつ。はれた ひの ひるまに とんでいるよ。",
    food: "はなの みつと はなふん。",
    care: "はちは はりが あるから、つかまえないで みるだけに しようね。はなの まわりを そっと みまもるのが いちばん だよ。",
  },
  katatsumuri: {
    trivia: ["はの かずは 1まん いじょう。ちいさな やすりの ような はで はを けずって たべるよ。",
             "からは からだの いちぶ。とれたら いきて いけないんだ。",
             "オスと メスの りょうほうの やくわりを もっているよ。"],
    habitat: "ぜんこくの あじさいの は・いしがき・かべ。あめの ひや あめあがりに よく でて くるよ。",
    season: "5がつ〜7がつ（つゆの ころ）が いちばん おおいよ。",
    food: "やわらかい は・きゅうり・にんじん。からを つくる ために たまごの からも たべるよ。",
    care: "つちと おちばを いれた いれものに、きりふきで しめりけを たもつ。きゅうりや にんじん、そして たまごの からを すこし いれて あげてね。さわったら てを あらおう。",
  },
  kumo: {
    trivia: ["すの いとは おなじ ふとさの はがねより つよいと いわれているよ。",
             "むしでは なくて、あしが 8ほんの「クモの なかま」だよ。",
             "すの まんなかは べたべたしない ところ。じぶんは くっつかないんだ。"],
    habitat: "ぜんこくの きの あいだ・のきした・くさむら。ひとの すくない しずかな ばしょに すを はるよ。",
    season: "4がつ〜11がつ。あさの すは つゆが ついて きれいだよ。",
    food: "すに かかった むし。",
    care: "すごと うつすのは むずかしいよ。すを こわさず、そのまま かんさつ するのが いちばん。どんな むしが かかるか みてみよう。",
  },
  koganemushi: {
    trivia: ["せなかが きんいろや みどりに ひかるのは、ひかりの はんしゃの しくみ だよ。",
             "ようちゅうは つちの なかで きの ねを たべて そだつんだ。",
             "とぶのが じょうずで、ブーンと おとを たてて とぶよ。"],
    habitat: "ぜんこくの こうえん・はやし・にわ。さくらや けやき、くぬぎの はに あつまるよ。",
    season: "6がつ〜8がつ。ひるまも よるも みつかるよ。",
    food: "きの は・くだもの。かうときは こんちゅうゼリー。",
    care: "つちを いれた むしかごに、のぼりぎと こんちゅうゼリー。かんたんに かえるよ。つちが かわかない ように きりふきを。",
  },
  amenbo: {
    trivia: ["あしの さきに こまかい けが たくさん あって、みずに しずまないんだ。",
             "みずめんの ゆれを かんじて、おちた むしを みつけるよ。",
             "つかまえると あめのような あまい においが するから「アメンボ」って いうんだ。"],
    habitat: "ぜんこくの いけ・ぬま・ながれの ゆるやかな かわ。みずめんを すべる ように うごくよ。",
    season: "4がつ〜10がつ。あたたかい ひの ひるまに おおいよ。",
    food: "みずに おちた ちいさな むし。",
    care: "ひろい みずそうと いきた えさが ひつようで、かうのは むずかしいよ。いけで すべる ようすを みるのが いちばん たのしいんだ。",
  },
  suzumushi: {
    trivia: ["「リーンリーン」と すずの ような きれいな こえで なくよ。",
             "ないているのは オスだけ。はねを こすって おとを だすんだ。",
             "むかしから にほんでは、なきごえを たのしむ むしと して かわれて きたよ。"],
    habitat: "ぜんこくの くさむら・はやしの ふち。くらくて しめった ところに かくれているよ。",
    season: "8がつ〜10がつ。ゆうがたから よるに ないているよ。",
    food: "きゅうり・なす・にぼし・かつおぶし。",
    care: "つちを しいた むしかごに かくれる ばしょを いれる。きゅうりや なすを ようじに さして、にぼしも すこし。つちを きりふきで しめらせてね。かいやすくて、なきごえが たのしめるよ。",
  },

  /* ---- おはな ---- */
  tanpopo: {
    trivia: ["きいろい はなは、ちいさな はなが 100〜200こも あつまって できているよ。",
             "わたげは かぜに のって 1キロも とぶことが あるんだ。",
             "ねは 1メートル ちかく ふかく のびるから、ぬいても また はえて くるよ。"],
    habitat: "ぜんこくの みちばた・こうえん・かわら・グラウンドの すみ。ひあたりの よい じめんなら どこでも はえるよ。",
    season: "3がつ〜5がつ（あきに さく ものも あるよ）。",
    food: "ひなたと みずはけの よい つち。",
    care: "わたげの たねを つちに まいて、かるく つちを かけて みずを あげるだけ。とても つよくて そだてやすいよ。はちは ふかい ものを えらんでね。",
  },
  sakura: {
    trivia: ["にほんの ソメイヨシノは ぜんぶ、1ぽんの きから ふやした「クローン」なんだ。だから いっせいに さくよ。",
             "はなが さきおわってから はっぱが でて くる しゅるいが おおいよ。",
             "はなびらは 5まい。よく みて かぞえて みてね。"],
    habitat: "ぜんこく（おきなわを のぞく）の こうえん・かわぞい・がっこう。ひあたりの よい ひろい ばしょに うえられているよ。",
    season: "3がつ〜4がつ。さいてから ちるまで 1〜2しゅうかん くらい。",
    food: "ひなたと、みずはけの よい ひろい つち。",
    care: "おおきな きに なるから、おうちで そだてるなら「さくらんぼの きの なかま」や はちうえよう の ちいさな しゅるいを えらぼう。えだを きるのは にがてな きだから、きらない ほうが げんき だよ。",
  },
  tulip: {
    trivia: ["つちの なかの「きゅうこん」から そだつよ。たまねぎみたいな かたち なんだ。",
             "よるや あめの ひは はなを とじて、はれると また ひらくよ。",
             "むかし オランダでは、きゅうこん 1つが いえ 1けんの ねだんに なったことが あるんだ。"],
    habitat: "かだん・はちうえ・こうえんの はなだん。もともとは トルコあたりの やまの はな だよ。",
    season: "3がつ〜5がつ。",
    food: "ひなたと、みずはけの よい つち。",
    care: "10がつ〜11がつに きゅうこんを、とがった ほうを うえに して つちに うめる。ふかさは きゅうこん 2〜3こぶん。ふゆの あいだ そとに おいて、つちが かわいたら みずを あげれば はるに さくよ。",
  },
  himawari: {
    trivia: ["ちいさい うちは たいようを おいかけて むきを かえるけど、おおきく なると ひがしを むいた まま になるよ。",
             "まんなかの たねは うずまきの ならびかた。すうがくの きれいな ルールに なっているんだ。",
             "せかいで いちばん たかい ヒマワリは 9メートル いじょうに なったよ。"],
    habitat: "かだん・はたけ・がっこうの はなだん。ひあたりの よい ひろい ばしょが すき だよ。",
    season: "7がつ〜9がつ。",
    food: "たっぷりの ひなたと みず。",
    care: "5がつごろ たねを 2〜3センチの ふかさに まく。めが でたら げんきな ものを 1ぽん のこす。なつは あさに たっぷり みずを あげてね。せが たかい しゅるいは ぼうで ささえよう。",
  },
  asagao: {
    trivia: ["つるは かならず ひだりまきに まきついて のびるよ。",
             "あさ はやく さいて、ひるには しぼんで しまうんだ。",
             "つぼみは さく 2じかん くらい まえから ゆっくり ひらきはじめるよ。"],
    habitat: "にわ・ベランダ・がっこうの はなだん。つるが まきつく ものが あれば どこでも そだつよ。",
    season: "7がつ〜9がつ。あさ 4じ〜7じごろに ひらくよ。",
    food: "ひなたと、まいにちの みず。",
    care: "5がつごろ たねを まいて、めが でたら はちに うつす。つるが のびる ぼうや ネットを たてて あげてね。なつは あさと ゆうがた、みずを たっぷり。1ねんせいの ていばん だよ。",
  },
  clover: {
    trivia: ["よつばに なるのは 1まんぼんに 1ぽん くらい。ふまれた ところに でやすいと いわれているよ。",
             "はっぱの しろい もようは、しゅるいに よって かたちが ちがうんだ。",
             "つちを ゆたかに する ちからが あって、はたけの おてつだいに つかわれるよ。"],
    habitat: "ぜんこくの こうえんの しばふ・かわら・グラウンドの すみ。ひあたりの よい じめんに ひろがるよ。",
    season: "はなは 4がつ〜7がつ。はっぱは 1ねんじゅう みられるよ。",
    food: "ひなたと、ふつうの つち。",
    care: "たねを つちに ぱらぱら まいて、かるく つちを かけるだけ。とても つよいから ほったらかしでも ふえるよ。はなかんむりを つくって あそんで みてね。",
  },
  kinoko: {
    trivia: ["しょくぶつでは なくて「きんるい」の なかま。はっぱも ねも ないんだ。",
             "みえている ぶぶんは ほんの いちぶ。つちの なかに いとの ような からだが ひろがっているよ。",
             "かれた きや はっぱを つちに かえす、もりの おそうじやさん だよ。"],
    habitat: "ぜんこくの はやし・こうえんの きの ねもと・おちばの うえ。あめの あとの しめった ばしょに でて くるよ。",
    season: "6がつ〜11がつ。あめの つぎの ひが みつけやすいよ。",
    food: "かれた き・おちば（そこから えいようを もらうよ）。",
    care: "やまの きのこは たべられない ものや どくの ある ものが あるから、ぜったいに くちに いれないでね。さわったら てを あらおう。たべる きのこは「さいばいキット」で おうちでも そだてられるよ。",
  },
  donguri: {
    trivia: ["どんぐりは「き の たね」。はるに なると めが でて、ちいさな きに なるよ。",
             "しゅるいに よって かたちが ちがう。まるいの、ほそながいの、ぼうしが もじゃもじゃの ものも あるんだ。",
             "リスや ネズミが つちに うめて わすれた どんぐりが、あたらしい きに なるんだよ。"],
    habitat: "ぜんこくの こうえん・はやしの、くぬぎ・こなら・しいの きの した。あきに たくさん おちているよ。",
    season: "9がつ〜11がつ。",
    food: "つちと みず（めが でて からは ひなたも ひつよう）。",
    care: "みずに いれて しずむ どんぐりを えらんで、はちの つちに よこむきに うめる。そとに おいて つちが かわいたら みずを あげると、はるに めが でるよ。むしが でることが あるから、ひろったら 1にち れいとうこに いれると あんしん。",
  },
  momiji: {
    trivia: ["あかく なるのは、はっぱの みどりが なくなって、あかい いろが でて くるから だよ。",
             "たねには はねが ついていて、くるくる まわりながら とんでいくよ。",
             "ひると よるの きおんの さが おおきい ほど、きれいな あかに なるんだ。"],
    habitat: "ぜんこくの やま・こうえん・にほんていえん。すこし ひかげで しめった ばしょが すき だよ。",
    season: "はっぱが あかく なるのは 11がつ〜12がつ。",
    food: "はんひかげと、かわきすぎない つち。",
    care: "はちうえでも そだてられるよ。なつの つよい ひざしと かわきが にがてだから、はんひかげに おいて つちが かわいたら みずを たっぷり。ふゆに かたちを ととのえる くらいで だいじょうぶ。",
  },
};
