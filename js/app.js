...
(() => {
  ...
  const JP_W = 941, JP_H = 1672;               // め じるしを きめた ときの え の おおきさ
  const JP_AX = [64.711730, -25.099729, -7452.7779];   // x = a*けいど + b*いど + c
  const JP_AY = [0.893974, -80.756311, 3635.9111];     // y = a*けいど + b*いど + c
  /* [いど, けいど, xの のこり, yの のこり]
     め じるしは、え の 中(なか)の 海岸線(かいがんせん)の はしっこを
     コンピューターに はからせて きめた（岬(みさき)や 島(しま)の 先(さき)）。*/
  const JP_FIX = [
    [45.52, 141.94,   66,  -19],   // 宗谷岬
    [43.39, 145.82,   10,  -20],   // 納沙布岬
    [41.55, 140.91,  -13,  -21],   // 大間崎
    [37.51, 137.34,  -22,  -30],   // 能登半島の 先
    [35.71, 140.87,    7,   51],   // 犬吠埼
    [35.66, 139.75,  -24,  -19],   // 東京タワー
    [33.95, 130.94,   -5,  -21],   // 下関
    [33.44, 135.76,   15,  -43],   // 潮岬
    [33.24, 134.18,  -51,   72],   // 室戸岬
    [32.72, 133.02,  -46,  102],   // 足摺岬
    [31.03, 130.67, -123,  132],   // 佐多岬
    [28.32, 129.50,  161, -116],   // 奄美大島
    [26.50, 127.98,   25,  -68],   // 沖縄本島
  ];
